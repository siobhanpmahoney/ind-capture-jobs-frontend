...
// https://capture-jobs-api.herokuapp.com/api/foo/bar -> http://www.example.org/api/foo/bar
```
...
var options = {
        ...
        router: {
            // when request.headers.host == 'dev.capture-jobs-api.herokuapp.com',
            // override target 'http://www.example.org' to 'http://localhost:8000'
            'dev.capture-jobs-api.herokuapp.com' : 'http://localhost:8000'
        }
    };
...
* **option.router**: object/function, re-target `option.target` for specific requests.
    ...
    router: {
        'integration.capture-jobs-api.herokuapp.com' : 'http://localhost:8001',  // host only
        'staging.capture-jobs-api.herokuapp.com'     : 'http://localhost:8002',  // host only
        'capture-jobs-api.herokuapp.com/api'         : 'http://localhost:8003',  // host + path
