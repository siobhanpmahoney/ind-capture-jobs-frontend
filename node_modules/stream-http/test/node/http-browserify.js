...
test('Test alt protocol', function(t) {
	...
	var resolved = url.resolve(location, request._opts.url)
	t.equal(resolved, 'foo://capture-jobs-api.herokuapp.com/bar', 'Url should be correct')
	t.end()
})
...
test('Test page with \'file:\' protocol', function (t) {
	...
	t.equal(resolved, 'https://capture-jobs-api.herokuapp.com/bar', 'Url should be correct')
	t.end()
})
